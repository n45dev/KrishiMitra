...
class ProductCartAdapter(private val products: List<Product>, private val listener: OnItemClickListener) : RecyclerView.Adapter<ProductCartAdapter.ProductViewHolder>() {
    ...
    inner class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        private val remBtn = itemView.findViewById<TextView>(R.id.removeButton)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.product_cart_card, parent, false)
